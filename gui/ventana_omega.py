...
class VentanaOmega(tk.Frame):
    ...
    def crear_widgets(self):
        ...
        for s in (section1, section2):
            ...
            s.grid_rowconfigure(1, weight=0, minsize=257)  # footer fijo de 210px
        ...
        footer1 = ttk.Frame(section1, style="Omega.TFrame", borderwidth=2, relief="groove")
        footer2 = ttk.Frame(section2, style="Omega.TFrame", borderwidth=2, relief="groove")
