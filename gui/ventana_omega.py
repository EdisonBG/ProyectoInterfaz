...
class VentanaOmega(tk.Frame):
    ...
    def crear_widgets(self):
        ...
        self.grid_columnconfigure(0, weight=0, minsize=95)
        ...
        section1 = ttk.Frame(cont, style="Omega.TFrame",
                             borderwidth=2, relief="groove")
        section2 = ttk.Frame(cont, style="Omega.TFrame",
                             borderwidth=2, relief="groove")
        ...
        for s in (section1, section2):
            ...
            # footer fijo de 210px
            s.grid_rowconfigure(1, weight=0, minsize=257)
        ...
        footer1 = ttk.Frame(section1, style="Omega.TFrame",
                            borderwidth=2, relief="groove")
        footer2 = ttk.Frame(section2, style="Omega.TFrame",
                            borderwidth=2, relief="groove")

        # Que el footer llene la fila completa (alto y ancho)
        footer1.grid(row=1, column=0, sticky="nsew", padx=10, pady=(0, 10))
        footer2.grid(row=1, column=0, sticky="nsew", padx=10, pady=(0, 10))
        ...
        self.paneles = {}
        panel1 = PanelOmega(content1, id_omega=1,
                            controlador=self.controlador, arduino=self.arduino)
        panel1.set_contenedor_inferior(footer1)
        panel2 = PanelOmega(content2, id_omega=2,
                            controlador=self.controlador, arduino=self.arduino)
        panel2.set_contenedor_inferior(footer2)
        try:
